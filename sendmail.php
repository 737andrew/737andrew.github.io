...
<form action="send.php" method="post" id="cForm">
...
<div class="contact-form-wrapper">
	<form class="form-horizontal" action="mail.php" method="post" role="form" >
		<div class="form-group">
				<label for="Name" class="col-sm-3 control-label"><b>Ваше полное имя</b></label>
			<div class="col-sm-6">
		...
		<div class="form-group">
				<label for="contact-phone" class="col-sm-3 control-label"><b>Ваш Телефон</b></label>
			<div class="col-sm-6">
				<input class="form-control" id="contact-phone" type="text" placeholder="">
			</div>
		</div>
		<div class="form-group">
