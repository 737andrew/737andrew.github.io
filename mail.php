...
$myemail = "gips@montagnik.od.ua";
/* Проверяем заполнены ли обязательные поля ввода, используя check_input 
функцию */
$your_name = check_input($_POST["Name"], "Введите ваше имя!");
$email = check_input($_POST["contact-email"], "Введите ваш e-mail!");
$phone = check_input($_POST["contact-phone"], "Введите ваш номер телефона!");
$message = check_input($_POST["contact-message"], "Вы забыли написать сообщение!");
